...
|----------|----------|----------|---------|
| 착수 회의 (기획서, WBS 검토) | 2026-02-01 | 2026-02-01 | 1 |
| 데이터 요구사항 정의 | 2026-02-02 | 2026-02-03 | 2 |
| 데이터 수집 및 전처리 | 2026-02-04 | 2026-02-10 | 7 |
| 데이터 증강 및 피처 엔지니어링 | 2026-02-11 | 2026-02-17 | 7 |
| 모델 선택 및 학습 (6개 모델 비교) | 2026-02-18 | 2026-02-24 | 7 |
| XGBoost 하이퍼파라미터 튜닝 | 2026-02-25 | 2026-03-03 | 7 |
| Streamlit 대시보드 개발 | 2026-03-04 | 2026-03-17 | 14 |
| DB 설계 및 API 연동 | 2026-03-04 | 2026-03-17 | 14 |
| 최종 검토 및 프로젝트 발표 | 2026-03-18 | 2026-03-24 | 7 |
...
## 2. 수집 방식
- **연동 방식**: 기상청 단기예보 API (JSON) + KAMP CSV 파일 배치 수집
...
- **허유나 (팀장)**:
  - 강점: 프로젝트 전체 방향 설정 및 발표 준비를 주도적으로 이끌어감
  - 개선점: 일정 관리 시 버퍼 시간 추가 필요

- **이형주 (서기/기술보조)**:
  - 강점: 회의록 및 문서 정리를 꼼꼼하게 수행
  - 개선점: 기술 구현 참여도 높이기

- **강창희 (기술리더)**:
  - 강점: 모델링 및 핵심 알고리즘 구현을 책임감 있게 수행
  - 개선점: 진행 상황 팀원과 더 자주 공유

- **박순선 (스케줄관리자)**:
  - 강점: 일정 관리 및 팀 조율 역할 충실히 수행
  - 개선점: 기술적인 부분도 함께 학습하면 좋을 것 같음
